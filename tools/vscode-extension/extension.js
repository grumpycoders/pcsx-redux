        ...
        <vscode-panels>
          ...
          <vscode-panel-view id="welcome-view">
            <div>
              ...
              <p>The TEMPLATE panel will let you create a new project based on some provided templates. Each template has a set of required and recommended tools. The required tools are going to be necessary to create and build a project, while the recommended tools will be necessary to launch and debug it.</p>
