...
/* PATCHED per lua-ffi-wasm README.md:61 - configure autodetected host
   x86_64-pc-linux-gnu (emconfigure passes no --host), so this arrived set from
   an x86 answer. Static trampolines need executable pages; wasm has none. */
