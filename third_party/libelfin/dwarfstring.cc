...
std::string to_string(section_type v) {
    switch (v) {
        case section_type::abbrev:
            return "section_type::abbrev";
        case section_type::aranges:
            return "section_type::aranges";
        case section_type::frame:
            return "section_type::frame";
        case section_type::info:
            return "section_type::info";
        case section_type::line:
            return "section_type::line";
        case section_type::loc:
            return "section_type::loc";
        case section_type::macinfo:
            return "section_type::macinfo";
        case section_type::pubnames:
            return "section_type::pubnames";
        case section_type::pubtypes:
            return "section_type::pubtypes";
        case section_type::ranges:
            return "section_type::ranges";
        case section_type::str:
            return "section_type::str";
...
std::string to_string(expr_result::type v) {
    switch (v) {
        case expr_result::type::address:
            return "expr_result::type::address";
        case expr_result::type::reg:
            return "expr_result::type::reg";
        case expr_result::type::literal:
            return "expr_result::type::literal";
        case expr_result::type::implicit:
            return "expr_result::type::implicit";
        case expr_result::type::empty:
            return "expr_result::type::empty";
    }
...
std::string to_string(DW_DS v) {
    switch (v) {
        case DW_DS::unsigned_:
            return "DW_DS_unsigned";
        case DW_DS::leading_overpunch:
            return "DW_DS_leading_overpunch";
        case DW_DS::trailing_overpunch:
            return "DW_DS_trailing_overpunch";
        case DW_DS::leading_separate:
            return "DW_DS_leading_separate";
        case DW_DS::trailing_separate:
...
std::string to_string(DW_ACCESS v) {
    switch (v) {
        case DW_ACCESS::public_:
            return "DW_ACCESS_public";
        case DW_ACCESS::protected_:
            return "DW_ACCESS_protected";
        case DW_ACCESS::private_:
...
std::string to_string(DW_VIS v) {
    switch (v) {
        case DW_VIS::local:
            return "DW_VIS_local";
        case DW_VIS::exported:
            return "DW_VIS_exported";
        case DW_VIS::qualified:
...
std::string to_string(DW_VIRTUALITY v) {
    switch (v) {
        case DW_VIRTUALITY::none:
            return "DW_VIRTUALITY_none";
        case DW_VIRTUALITY::virtual_:
            return "DW_VIRTUALITY_virtual";
        case DW_VIRTUALITY::pure_virtual:
...
std::string to_string(DW_LANG v) {
    switch (v) {
        ...
        case DW_LANG::C_plus_plus:
            return "DW_LANG_C_plus_plus";
        case DW_LANG::Cobol74:
            return "DW_LANG_Cobol74";
        case DW_LANG::Cobol85:
            return "DW_LANG_Cobol85";
        case DW_LANG::Fortran77:
            return "DW_LANG_Fortran77";
        case DW_LANG::Fortran90:
            return "DW_LANG_Fortran90";
        case DW_LANG::Pascal83:
            return "DW_LANG_Pascal83";
        case DW_LANG::Modula2:
        ...
        case DW_LANG::Fortran95:
            return "DW_LANG_Fortran95";
        case DW_LANG::PLI:
            return "DW_LANG_PLI";
        case DW_LANG::ObjC:
            return "DW_LANG_ObjC";
        case DW_LANG::ObjC_plus_plus:
        ...
        case DW_LANG::lo_user:
            break;
        case DW_LANG::hi_user:
            break;
    }
...
std::string to_string(DW_ID v) {
    switch (v) {
        case DW_ID::case_sensitive:
            return "DW_ID_case_sensitive";
        case DW_ID::up_case:
            return "DW_ID_up_case";
        case DW_ID::down_case:
            return "DW_ID_down_case";
        case DW_ID::case_insensitive:
...
std::string to_string(DW_INL v) {
    switch (v) {
        case DW_INL::not_inlined:
            return "DW_INL_not_inlined";
        case DW_INL::inlined:
            return "DW_INL_inlined";
        case DW_INL::declared_not_inlined:
            return "DW_INL_declared_not_inlined";
        case DW_INL::declared_inlined:
...
std::string to_string(DW_ORD v) {
    switch (v) {
        case DW_ORD::row_major:
            return "DW_ORD_row_major";
        case DW_ORD::col_major:
