...
CESTER_TEST(nclip_ccw, gte_tests,
    ...
    GTE_WRITE_DATA(13, 0x00000064);  // (100,0)
    GTE_WRITE_DATA(14, 0x00640000);  // (0,100)
    gte_clear_flag();
...
CESTER_TEST(nclip_large_coords, gte_tests,
    ...
    GTE_WRITE_DATA(12, (0xfc00 << 16) | 0x03ff);  // (0x3FF, -0x400)
    GTE_WRITE_DATA(13, (0x03ff << 16) | 0xfc00);  // (-0x400, 0x3FF)
    GTE_WRITE_DATA(14, 0x00000000);                // (0, 0)
    gte_clear_flag();
    GTE_EXEC(GTE_CMD_NCLIP);
    int32_t mac0;
    uint32_t flag;
...
CESTER_TEST(nclip_overflow, gte_tests,
    ...
    GTE_WRITE_DATA(12, (0x7fff << 16) | 0x7fff);  // (32767, 32767)
    GTE_WRITE_DATA(13, (0x8000 << 16) | 0x8000);  // (-32768, -32768)
    GTE_WRITE_DATA(14, (0x7fff << 16) | 0x8000);  // (-32768, 32767)
    gte_clear_flag();
    GTE_EXEC(GTE_CMD_NCLIP);
    int32_t mac0;
    uint32_t flag;
