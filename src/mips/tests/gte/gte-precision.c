...
CESTER_TEST(prec_mac1_positive_overflow, gte_tests,
            ...
            cop2_putc(1, 0x00000000); cop2_putc(2, 0x00000000); cop2_putc(3, 0x00000000); cop2_putc(4, 0);
            cop2_putc(5, 0x7fffffff);                                           // TRX = max positive 32-bit
            cop2_putc(6, 0); cop2_putc(7, 0); cop2_put(0, (0 << 16) | 0x7fff);  // VX=0x7FFF, VY=0
            cop2_put(1, 0); gte_clear_flag(); cop2_cmd(COP2_MVMVA(0, COP2_MX_RT, COP2_V_V0, COP2_CV_TR, 0));
            uint32_t flag = gte_read_flag(); uint32_t f30 = (flag >> 30) & 1;
            ramsyscall_printf("MAC1 pos overflow: FLAG=0x%08x F30=%u\n", flag, f30); cester_assert_uint_eq(1, f30);)

// MAC1 negative overflow (FLAG.27)
CESTER_TEST(prec_mac1_negative_overflow, gte_tests, cop2_putc(0, 0x00007fff);  // R11=0x7FFF
            cop2_putc(1, 0x00000000); cop2_putc(2, 0x00000000); cop2_putc(3, 0x00000000); cop2_putc(4, 0);
            cop2_putc(5, 0x80000000);                                           // TRX = min negative 32-bit
            cop2_putc(6, 0); cop2_putc(7, 0); cop2_put(0, (0 << 16) | 0x8000);  // VX=-0x8000 (negative)
            cop2_put(1, 0); gte_clear_flag(); cop2_cmd(COP2_MVMVA(0, COP2_MX_RT, COP2_V_V0, COP2_CV_TR, 0));
            uint32_t flag = gte_read_flag(); uint32_t f27 = (flag >> 27) & 1;
            ramsyscall_printf("MAC1 neg overflow: FLAG=0x%08x F27=%u\n", flag, f27); cester_assert_uint_eq(1, f27);)

// MAC2 overflow (FLAG.29 positive, FLAG.26 negative)
CESTER_TEST(prec_mac2_overflow, gte_tests, cop2_putc(0, 0x00000000);
            cop2_putc(1, 0x7fff0000);  // R21=0x7FFF (high16 of R13R21), R13=0
            cop2_putc(2, 0x00000000); cop2_putc(3, 0x00000000); cop2_putc(4, 0); cop2_putc(5, 0);
            cop2_putc(6, 0x7fffffff);  // TRY = max
            cop2_putc(7, 0); cop2_put(0, (0 << 16) | 0x7fff); cop2_put(1, 0); gte_clear_flag();
            cop2_cmd(COP2_MVMVA(0, COP2_MX_RT, COP2_V_V0, COP2_CV_TR, 0)); uint32_t flag = gte_read_flag();
            uint32_t f29 = (flag >> 29) & 1; ramsyscall_printf("MAC2 pos overflow: FLAG=0x%08x F29=%u\n", flag, f29);
            cester_assert_uint_eq(1, f29);)

// MAC3 overflow (FLAG.28 positive, FLAG.25 negative)
CESTER_TEST(prec_mac3_overflow, gte_tests, cop2_putc(0, 0x00000000); cop2_putc(1, 0x00000000); cop2_putc(2, 0x00000000);
            cop2_putc(3, 0x00007fff);  // R31=0x7FFF (high16 of R31R32)
            cop2_putc(4, 0); cop2_putc(5, 0); cop2_putc(6, 0); cop2_putc(7, 0x7fffffff);  // TRZ = max
            cop2_put(0, (0 << 16) | 0x7fff); cop2_put(1, 0); gte_clear_flag();
            cop2_cmd(COP2_MVMVA(0, COP2_MX_RT, COP2_V_V0, COP2_CV_TR, 0)); uint32_t flag = gte_read_flag();
            uint32_t f28 = (flag >> 28) & 1; ramsyscall_printf("MAC3 pos overflow: FLAG=0x%08x F28=%u\n", flag, f28);
...
CESTER_TEST(prec_mac_double_overflow, gte_tests,
            ...
            cop2_put(9, 0); cop2_put(10, 0x7fff);          // IR2
            cop2_put(11, 0x7fff);                          // IR3
            gte_clear_flag(); cop2_cmd(COP2_OP_CP(0, 0));  // sf=0
            int32_t mac1; uint32_t flag; cop2_get(25, mac1); flag = gte_read_flag();
            ...
            cester_assert_int_eq(0, mac1); cester_assert_uint_eq(0, flag);)
...
CESTER_TEST(prec_div_1_over_1, gte_tests, gte_set_identity_rotation(); gte_set_translation(0, 0, 0);
            cop2_putc(24, 0);                                                     // OFX=0
            cop2_putc(25, 0); cop2_putc(26, 1);                                   // H=1
            cop2_putc(27, 0); cop2_putc(28, 0); cop2_put(0, (0 << 16) | 0x1000);  // VX=0x1000, VY=0
...
CESTER_TEST(prec_div_100_over_1000, gte_tests, gte_set_identity_rotation(); gte_set_translation(0, 0, 0);
            cop2_putc(24, 0); cop2_putc(25, 0); cop2_putc(26, 100);             // H=100
            cop2_putc(27, 0); cop2_putc(28, 0); cop2_put(0, (0 << 16) | 1000);  // VX=1000
            cop2_put(1, 1000);                                                  // VZ=1000
            gte_clear_flag(); cop2_cmd(COP2_RTPS(1, 0)); uint32_t sxy2; cop2_get(14, sxy2);
            int16_t sx = (int16_t)(sxy2 & 0xffff); ramsyscall_printf("div 100/1000: SX=%d\n", sx);
...
CESTER_TEST(prec_div_corner_f015_780b, gte_tests, gte_set_identity_rotation(); gte_set_translation(0, 0, 0);
            cop2_putc(24, 0); cop2_putc(25, 0); cop2_putc(26, 0xf015);       // H
            cop2_putc(27, 0); cop2_putc(28, 0); cop2_put(0, (0 << 16) | 1);  // VX=1 (minimal to see quotient effect)
...
CESTER_TEST(prec_div_large_h, gte_tests, gte_set_identity_rotation(); gte_set_translation(0, 0, 0); cop2_putc(24, 0);
            cop2_putc(25, 0); cop2_putc(26, 0xfffe);  // H near max
            cop2_putc(27, 0); cop2_putc(28, 0); cop2_put(0, (0 << 16) | 1);
            ...
            uint32_t f17 = (flag >> 17) & 1; ramsyscall_printf("div large H: FLAG=0x%08x F17=%u\n", flag, f17);
            cester_assert_uint_eq(1, f17);  // H >= SZ3*2 is true (equal counts)
)

// SZ3=1 with moderate H (quotient near max)
CESTER_TEST(prec_div_sz3_one, gte_tests, gte_set_identity_rotation(); gte_set_translation(0, 0, 0); cop2_putc(24, 0);
            cop2_putc(25, 0); cop2_putc(26, 1);                                              // H=1
            cop2_putc(27, 0); cop2_putc(28, 0); cop2_put(0, (0 << 16) | 1); cop2_put(1, 1);  // SZ3=1
            gte_clear_flag(); cop2_cmd(COP2_RTPS(1, 0)); uint32_t sxy2, flag; int32_t ir1; cop2_get(14, sxy2);
            cop2_get(9, ir1); flag = gte_read_flag(); int16_t sx = (int16_t)(sxy2 & 0xffff);
...
CESTER_TEST(prec_rtps_sf0_ir3_flag_anomaly, gte_tests, gte_set_identity_rotation();
            ...
            cop2_putc(5, 0); cop2_putc(6, 0); cop2_putc(7, 0);  // TRZ = 0
            cop2_putc(24, 0); cop2_putc(25, 0); cop2_putc(26, 200); cop2_putc(27, 0); cop2_putc(28, 0);
            // VZ = 8 -> MAC3 = 0 + 0x1000*8 = 0x8000 (just over 0x7FFF)
            cop2_put(0, 0x00000000); cop2_put(1, 8); gte_clear_flag(); cop2_cmd(COP2_RTPS(0, 0));  // sf=0
            int32_t mac3; uint32_t ir3, flag; cop2_get(27, mac3); cop2_get(11, ir3); flag = gte_read_flag();
            ...
            cester_assert_int_eq(32768, mac3); cester_assert_uint_eq(0x7fff, ir3); cester_assert_uint_eq(0, f22);
            uint32_t f17 = (flag >> 17) & 1; cester_assert_uint_eq(1, f17);)

// Stronger test: MAC3 = 0x10000 -> well above 0x7FFF, but >>12 = 1 (in range)
CESTER_TEST(prec_rtps_sf0_ir3_flag_strong, gte_tests, gte_set_identity_rotation(); cop2_putc(5, 0); cop2_putc(6, 0);
            cop2_putc(7, 0); cop2_putc(24, 0); cop2_putc(25, 0); cop2_putc(26, 200); cop2_putc(27, 0); cop2_putc(28, 0);
            // VZ = 16 -> MAC3 = 0x1000 * 16 = 0x10000 (65536, way above 0x7FFF)
            cop2_put(0, 0x00000000); cop2_put(1, 16); gte_clear_flag(); cop2_cmd(COP2_RTPS(0, 0)); int32_t mac3;
            uint32_t ir3, flag; cop2_get(27, mac3); cop2_get(11, ir3); flag = gte_read_flag();
            uint32_t f22 = (flag >> 22) & 1;
...
CESTER_TEST(prec_rtps_sf0_ir3_flag_set, gte_tests, gte_set_identity_rotation(); cop2_putc(5, 0); cop2_putc(6, 0);
            ...
            cop2_putc(7, 0x7fff); cop2_put(0, 0x00000000); cop2_put(1, 1); gte_clear_flag(); cop2_cmd(COP2_RTPS(0, 0));
            int32_t mac3; uint32_t ir3, flag; cop2_get(27, mac3); cop2_get(11, ir3); flag = gte_read_flag();
            uint32_t f22 = (flag >> 22) & 1;
