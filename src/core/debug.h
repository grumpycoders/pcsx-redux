...
#define CDR_LOG(...)                                                             \
    {                                                                            \
        PCSX::CDR_LOGGER::Log("%8.8lx %8.8lx: ", g_psxRegs.pc, g_psxRegs.cycle); \
        PCSX::CDR_LOGGER::Log(__VA_ARGS__);                                      \
    }
#define CDR_LOG_IO(...)                                                            \
    {                                                                              \
        PCSX::CDRIO_LOGGER::Log("%8.8lx %8.8lx: ", g_psxRegs.pc, g_psxRegs.cycle); \
        PCSX::CDRIO_LOGGER::Log(__VA_ARGS__);                                      \
    }
#define EMU_LOG PCSX::EMU_LOGGER::Log
#define PSXHW_LOG(...)                                                             \
    {                                                                              \
        PCSX::PSXHW_LOGGER::Log("%8.8lx %8.8lx: ", g_psxRegs.pc, g_psxRegs.cycle); \
...
#define PSXBIOS_LOG(...)                                                             \
    {                                                                                \
        PCSX::PSXBIOS_LOGGER::Log("%8.8lx %8.8lx: ", g_psxRegs.pc, g_psxRegs.cycle); \
        PCSX::PSXBIOS_LOGGER::Log(__VA_ARGS__);                                      \
    }
#define PSXDMA_LOG PCSX::PSXDMA_LOGGER::Log
#define PSXMEM_LOG(...)                                                             \
    {                                                                               \
        PCSX::PSXMEM_LOGGER::Log("%8.8lx %8.8lx: ", g_psxRegs.pc, g_psxRegs.cycle); \
