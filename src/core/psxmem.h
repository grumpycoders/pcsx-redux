...
#define SWAP_LE32(v) ((((v)&0xff000000ul) >> 24) | (((v)&0xff0000ul) >> 8) | (((v)&0xff00ul) << 8) | (((v)&0xfful) << 24))
...
#define psxMs16(mem) (SWAP_LE16(*(int16_t *)&g_psxM[(mem)&0x1fffff]))
#define psxMs32(mem) (SWAP_LE32(*(int32_t *)&g_psxM[(mem)&0x1fffff]))
#define psxMu8(mem) (*(uint8_t *)&g_psxM[(mem)&0x1fffff])
#define psxMu16(mem) (SWAP_LE16(*(uint16_t *)&g_psxM[(mem)&0x1fffff]))
#define psxMu32(mem) (SWAP_LE32(*(uint32_t *)&g_psxM[(mem)&0x1fffff]))
...
#define psxPs16(mem) (SWAP_LE16(*(int16_t *)&g_psxP[(mem)&0xffff]))
#define psxPs32(mem) (SWAP_LE32(*(int32_t *)&g_psxP[(mem)&0xffff]))
#define psxPu8(mem) (*(uint8_t *)&g_psxP[(mem)&0xffff])
#define psxPu16(mem) (SWAP_LE16(*(uint16_t *)&g_psxP[(mem)&0xffff]))
#define psxPu32(mem) (SWAP_LE32(*(uint32_t *)&g_psxP[(mem)&0xffff]))
...
#define psxRs16(mem) (SWAP_LE16(*(int16_t *)&g_psxR[(mem)&0x7ffff]))
#define psxRs32(mem) (SWAP_LE32(*(int32_t *)&g_psxR[(mem)&0x7ffff]))
#define psxRu8(mem) (*(uint8_t *)&g_psxR[(mem)&0x7ffff])
#define psxRu16(mem) (SWAP_LE16(*(uint16_t *)&g_psxR[(mem)&0x7ffff]))
#define psxRu32(mem) (SWAP_LE32(*(uint32_t *)&g_psxR[(mem)&0x7ffff]))
...
#define psxHs16(mem) (SWAP_LE16(*(int16_t *)&g_psxH[(mem)&0xffff]))
#define psxHs32(mem) (SWAP_LE32(*(int32_t *)&g_psxH[(mem)&0xffff]))
#define psxHu8(mem) (*(uint8_t *)&g_psxH[(mem)&0xffff])
#define psxHu16(mem) (SWAP_LE16(*(uint16_t *)&g_psxH[(mem)&0xffff]))
#define psxHu32(mem) (SWAP_LE32(*(uint32_t *)&g_psxH[(mem)&0xffff]))
