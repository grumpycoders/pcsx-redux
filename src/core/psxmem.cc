    ...
    if (t == 0x1f80 || t == 0x9f80 || t == 0xbf80) {
        ...
        if (p != NULL) {
            if (PCSX::g_emulator.settings.get<PCSX::Emulator::SettingDebug>()) {
                PCSX::g_emulator.m_debug->DebugCheckBP(mem, PCSX::Debug::BR1);
            }
...
uint16_t PCSX::Memory::psxMemRead16(uint32_t mem) {
    ...
    if (t == 0x1f80 || t == 0x9f80 || t == 0xbf80) {
        ...
        if (p != NULL) {
            if (PCSX::g_emulator.settings.get<PCSX::Emulator::SettingDebug>()) {
                PCSX::g_emulator.m_debug->DebugCheckBP(mem, PCSX::Debug::BR2);
            }
...
uint32_t PCSX::Memory::psxMemRead32(uint32_t mem) {
    ...
    if (t == 0x1f80 || t == 0x9f80 || t == 0xbf80) {
        ...
        if (p != NULL) {
            if (PCSX::g_emulator.settings.get<PCSX::Emulator::SettingDebug>()) {
                PCSX::g_emulator.m_debug->DebugCheckBP(mem, PCSX::Debug::BR4);
            }
...
void PCSX::Memory::psxMemWrite8(uint32_t mem, uint8_t value) {
    ...
    if (t == 0x1f80 || t == 0x9f80 || t == 0xbf80) {
        ...
        if (p != NULL) {
            if (PCSX::g_emulator.settings.get<PCSX::Emulator::SettingDebug>()) {
                PCSX::g_emulator.m_debug->DebugCheckBP(mem, PCSX::Debug::BW1);
            }
...
void PCSX::Memory::psxMemWrite16(uint32_t mem, uint16_t value) {
    ...
    if (t == 0x1f80 || t == 0x9f80 || t == 0xbf80) {
        ...
        if (p != NULL) {
            if (PCSX::g_emulator.settings.get<PCSX::Emulator::SettingDebug>()) {
                PCSX::g_emulator.m_debug->DebugCheckBP(mem, PCSX::Debug::BW2);
            }
...
void PCSX::Memory::psxMemWrite32(uint32_t mem, uint32_t value) {
    ...
    if (t == 0x1f80 || t == 0x9f80 || t == 0xbf80) {
        ...
        if (p != NULL) {
            if (PCSX::g_emulator.settings.get<PCSX::Emulator::SettingDebug>()) {
                PCSX::g_emulator.m_debug->DebugCheckBP(mem, PCSX::Debug::BW4);
            }
