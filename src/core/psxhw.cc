...
void PCSX::HW::write16(uint32_t add, uint32_t rawvalue) {
    ...
    switch (hwadd) {
        case 0x1f801040:
            PCSX::g_emulator->m_sio->write8((uint8_t)value);  // 8-bit reg, ignore upper 8 bits
        ...
        case 0x1f80104e:  // baudrate register
            ...
            break;
        case 0x1f801050:  // rx/tx data register
            PCSX::g_emulator->m_sio1->writeData8((uint8_t)value); // 8-bit reg, ignore upper 8 bits
...
void PCSX::HW::write32(uint32_t add, uint32_t value) {
    ...
    switch (hwadd) {
        ...
        case 0x1f801040:
            ...
            break;
        case 0x1f801050:
            PCSX::g_emulator->m_sio1->writeData8((uint8_t)value);  // 8-bit reg, ignore upper 24 bits
