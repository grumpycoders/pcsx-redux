...
public:
  ...
  private:
    ...
    const func_t m_recSPC[64] = {
        ...
        &DynaRecCPU::recSLLV, &DynaRecCPU::recUnknown, &DynaRecCPU::recUnknown, &DynaRecCPU::recUnknown,  // 04
        ...
        &DynaRecCPU::recUnknown, &DynaRecCPU::recOR, &DynaRecCPU::recXOR, &DynaRecCPU::recUnknown,  // 24
