...
class CDRiso {
  ...
  private:
    ...
    typedef ssize_t (CDRiso::*read_func_t)(IO<UvFile> f, unsigned int base, void* dest, int sector);

    int64_t m_cdOpenCaseTime = 0;
    bool m_useCompressed = false;

    IO<UvFile> m_cdHandle;
    IO<UvFile> m_subHandle;
    ...
    struct trackinfo {
        ...
        IO<UvFile> handle = nullptr;                                       // for multi-track images CDDA
    ...
    ssize_t cdread_normal(IO<UvFile> f, unsigned int base, void* dest, int sector);
    ssize_t cdread_sub_mixed(IO<UvFile> f, unsigned int base, void* dest, int sector);
    ssize_t cdread_compressed(IO<UvFile> f, unsigned int base, void* dest, int sector);
    ssize_t cdread_2048(IO<UvFile> f, unsigned int base, void* dest, int sector);
    ssize_t cdread_ecm_decode(IO<UvFile> f, unsigned int base, void* dest, int sector);
    int handleecm(const char* isoname, IO<UvFile> cdh, int32_t* accurate_length);
    void PrintTracks();
    int aropen(IO<UvFile> fparchive, const char* _fn);
    int cdread_archive(IO<UvFile> f, unsigned int base, void* dest, int sector);
