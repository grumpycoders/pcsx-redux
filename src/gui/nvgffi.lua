...
nvg = {
    ...
    globalCompositeOperation = function(self, op)
        C.nvgGlobalCompositeOperation(self._ctx, op)
    end,
    ...
    restore = function(self)
        C.nvgRestore(self._ctx)
    end,
    reset = function(self)
        C.nvgReset(self._ctx)
    end,
    shapeAntiAlias = function(self, enabled)
        C.nvgShapeAntiAlias(self._ctx, enabled and 1 or 0)
    end,
    strokeColor = function(self, color)
        C.nvgStrokeColor(self._ctx, color)
    end,
    strokePaint = function(self, paint)
        C.nvgStrokePaint(self._ctx, paint)
    end,
    fillColor = function(self, color)
        C.nvgFillColor(self._ctx, color)
    end,
    fillPaint = function(self, paint)
        C.nvgFillPaint(self._ctx, paint)
    end,
    miterLimit = function(self, limit)
        C.nvgMiterLimit(self._ctx, limit)
    end,
    strokeWidth = function(self, size)
        C.nvgStrokeWidth(self._ctx, size)
    end,
    lineCap = function(self, cap)
        C.nvgLineCap(self._ctx, cap)
    end,
    lineJoin = function(self, join)
        C.nvgLineJoin(self._ctx, join)
    end,
    globalAlpha = function(self, alpha)
        C.nvgGlobalAlpha(self._ctx, alpha)
    end,
    resetTransform = function(self)
        C.nvgResetTransform(self._ctx)
    end,
    translate = function(self, x, y)
        C.nvgTranslate(self._ctx, x, y)
    end,
    rotate = function(self, angle)
        C.nvgRotate(self._ctx, angle)
    end,
    skewX = function(self, angle)
        C.nvgSkewX(self._ctx, angle)
    end,
    skewY = function(self, angle)
        C.nvgSkewY(self._ctx, angle)
    end,
    scale = function(self, x, y)
        C.nvgScale(self._ctx, x, y)
    end,
    currentTransform = function(self, xform)
        C.nvgCurrentTransform(self._ctx, xform)
    end,
    ...
    updateImage = function(self, image, data)
        C.nvgUpdateImage(self._ctx, image, data)
    end,
    imageSize = function(self, image, w, h)
        C.nvgImageSize(self._ctx, image, w, h)
    end,
    ...
    intersectScissor = function(self, x, y, w, h)
        C.nvgIntersectScissor(self._ctx, x, y, w, h)
    end,
    resetScissor = function(self)
        C.nvgResetScissor(self._ctx)
    end,
    beginPath = function(self)
        C.nvgBeginPath(self._ctx)
    end,
    moveTo = function(self, x, y)
        C.nvgMoveTo(self._ctx, x, y)
    end,
    lineTo = function(self, x, y)
        C.nvgLineTo(self._ctx, x, y)
    end,
    bezierTo = function(self, c1x, c1y, c2x, c2y, x, y)
        C.nvgBezierTo(self._ctx, c1x, c1y, c2x, c2y, x, y)
    end,
    quadTo = function(self, cx, cy, x, y)
        C.nvgQuadTo(self._ctx, cx, cy, x, y)
    end,
    arcTo = function(self, x1, y1, x2, y2, radius)
        C.nvgArcTo(self._ctx, x1, y1, x2, y2, radius)
    end,
    closePath = function(self)
        C.nvgClosePath(self._ctx)
    end,
    pathWinding = function(self, dir)
        C.nvgPathWinding(self._ctx, dir)
    end,
    arc = function(self, cx, cy, r, a0, a1, dir)
        C.nvgArc(self._ctx, cx, cy, r, a0, a1, dir)
    end,
    rect = function(self, x, y, w, h)
        C.nvgRect(self._ctx, x, y, w, h)
    end,
    roundedRect = function(self, x, y, w, h, r)
        C.nvgRoundedRect(self._ctx, x, y, w, h, r)
    end,
    ...
    ellipse = function(self, cx, cy, rx, ry)
        C.nvgEllipse(self._ctx, cx, cy, rx, ry)
    end,
    circle = function(self, cx, cy, r)
        C.nvgCircle(self._ctx, cx, cy, r)
    end,
    fill = function(self)
        C.nvgFill(self._ctx)
    end,
    stroke = function(self)
        C.nvgStroke(self._ctx)
    end,
    createFont = function(self, name, filename)
        return C.nvgCreateFont(self._ctx, name, filename)
    end,
    ...
    findFont = function(self, name)
        return C.nvgFindFont(self._ctx, name)
    end,
    ...
    addFallbackFont = function(self, baseFont, fallbackFont)
        C.nvgAddFallbackFont(self._ctx, baseFont, fallbackFont)
    end,
    resetFallbackFontsId = function(self, baseFont)
        C.nvgResetFallbackFontsId(self._ctx, baseFont)
    end,
    resetFallbackFonts = function(self, baseFont)
        C.nvgResetFallbackFonts(self._ctx, baseFont)
    end,
    fontSize = function(self, size)
        C.nvgFontSize(self._ctx, size)
    end,
    fontBlur = function(self, blur)
        C.nvgFontBlur(self._ctx, blur)
    end,
    textLetterSpacing = function(self, spacing)
        C.nvgTextLetterSpacing(self._ctx, spacing)
    end,
    textLineHeight = function(self, lineHeight)
        C.nvgTextLineHeight(self._ctx, lineHeight)
    end,
    textAlign = function(self, align)
        C.nvgTextAlign(self._ctx, align)
    end,
    fontFaceId = function(self, font)
        C.nvgFontFaceId(self._ctx, font)
    end,
    fontFace = function(self, font)
        C.nvgFontFace(self._ctx, font)
    end,
    text = function(self, x, y, string)
        C.nvgText(self._ctx, x, y, string, nil)
    end,
    textBox = function(self, x, y, breakRowWidth, string)
        C.nvgTextBox(self._ctx, x, y, breakRowWidth, string, nil)
    end,
