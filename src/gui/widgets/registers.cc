...
void PCSX::Widgets::Registers::draw(psxRegisters* registers, const char* title) {
    ...
    if (ImGui::BeginTabBar("Registers")) {
        ...
        if (ImGui::BeginTabItem("CP2 Data")) {
            ...
            ImGui::Text("sz0 : %i", registers->CP2D.n.sz0);
            ImGui::Text("sz1 : %i", registers->CP2D.n.sz1);
            ImGui::Text("sz2 : %i", registers->CP2D.n.sz2);
            ImGui::Text("sz3 : %i", registers->CP2D.n.sz3);
        ...
        if (ImGui::BeginTabItem("CP2 Control")) {
