...
class ISO9660Reader {
  public:
    ...
    typedef BinStruct::Struct<LongDate_Year, LongDate_Month, LongDate_Day, LongDate_Hour, LongDate_Minute,
                              LongDate_Second, LongDate_Hundredths, LongDate_TZ>
        LongDate;
    ...
    typedef BinStruct::Struct<DirEntry_Length, DirEntry_ExtLength, DirEntry_LBA, DirEntry_LBABE, DirEntry_Size,
                              DirEntry_SizeBE, DirEntry_Date, DirEntry_Flags, DirEntry_UnitSize, DirEntry_InterleaveGap,
                              DirEntry_VolSeqNo, DirEntry_VolSeqNoBE, DirEntry_Filename>
        DirEntry;
    ...
    typedef BinStruct::Struct<
        PVD_TypeCode, PVD_StdIdent, PVD_Version, PVD_Unused1, PVD_SystemIdent, PVD_VolumeIdent, PVD_Unused2,
        PVD_VolumeSpaceSize, PVD_VolumeSpaceSizeBE, PVD_Unused3, PVD_VolumeSetSize, PVD_VolumeSetSizeBE,
        PVD_VolumeSequenceNumber, PVD_VolumeSequenceNumberBE, PVD_LogicalBlockSize, PVD_LogicalBlockSizeBE,
        PVD_PathTableSize, PVD_PathTableSizeBE, PVD_LPathTableLocation, PVD_LPathTableOptLocation,
        PVD_MPathTableLocation, PVD_MPathTableOptLocation, PVD_RootDir, PVD_VolSetIdent, PVD_PublisherIdent,
        PVD_DataPreparerIdent, PVD_ApplicationIdent, PVD_CopyrightFileIdent, PVD_AbstractFileIdent,
        PVD_BibliographicFileIdent, PVD_VolumeCreationDate, PVD_VolumeModificationDate, PVD_VolumeExpirationDate,
        PVD_VolumeEffectiveDate, PVD_FileStructureVersion, PVD_Unused4, PVD_ApplicationUse, PVD_Reserved>
        PVD;
