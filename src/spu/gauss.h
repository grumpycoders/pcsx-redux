...
struct Gauss {
    ...
    // gauss512[0x0FF-i], gauss512[0x1FF-i], gauss512[0x100+i], gauss512[0x000+i]
    // applied oldest..newest, each product right-shifted 15 (SAR) before summing.
    // The four coefficients sum to 0x7F7F..0x7F81 rather than exactly 0x8000, which
